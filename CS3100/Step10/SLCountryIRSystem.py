from dict.sldict import *
from dict.abstract import CountryIRSystemAbstract
from Country import Country
import csv

class Country_SLDict(CountryIRSystemAbstract):
  
  def __init__(self):
    self.__country_dict = SLDict()
  ...
  def min_and_max(self, indicator):
    ...
    for x in self.__indicators:
      if x == indicator:
        ...
        list = self.__country_dict.getatt_sldict(attribute)
  ...
  def list_of_countries(self):
    ...
    country_list = self.__country_dict.getatt_sldict("country_name")
