from dict.htdict import *
from dict.abstract import CountryIRSystemAbstract
from Country import Country
import csv

class Country_htDict(CountryIRSystemAbstract):
  
  def __init__(self):
    self.__country_dict = HTDict()
  ...
  def min_and_max(self, indicator):
    ...
    for x in self.__indicators:
      if x == indicator:
        ...
        list = self.__country_dict.getatt_htdict(attribute)
  ...
  def list_of_countries(self):
    ...
    country_list = self.__country_dict.getatt_htdict("country_name")
    #country_list = [d['country name'] for d in self.__country_dict]
    #return an array
    return country_list
  ...
  def remove_country(self, user_country):
    ...
    #check each country
    if user_country in self.__country_dict.getatt_htdict("country_name"):
      #remove country from list
      self.__country_dict.pop(user_country)
      #print(self.__country_dict.pop(user_country))
